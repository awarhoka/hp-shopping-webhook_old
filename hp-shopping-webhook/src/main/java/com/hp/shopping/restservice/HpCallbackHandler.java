...
public class HpCallbackHandler {

    private static final String RESOURCE_URL = "https://localhost:9005/public";

    private static final Logger logger = LoggerFactory.getLogger(HpCallbackHandler.class);

    private final Messenger messenger;

    @Autowired
    public HpCallbackHandler(final Messenger messenger) {
